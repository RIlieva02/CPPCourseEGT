...
// Each TwoDimensionalShape should contain function getArea to calculate the area of
//the two-dimensional shape.
//Each ThreeDimensionalShape should have member
//functions getArea and getVolume to calculate the surface area and volume of the
//three-dimensional shape, respectively.
